# Spine Godot 3D - Spine Runtime 3.8

This branch/tree is the Godot 4.3+ GDExtension build of the Spine Godot 3D runtime for Spine Runtime 3.8 data.
...
| Spine Runtime branch | 3.8 only in this tree |
...
```text
GDScript_Build/example-v4-extension-Spine-3.8/
CSharp_Build/example-v4-csharp-Spine-3.8/
spine_godot/
build/
```
...
```powershell
.\build.bat -BuildFlavor gdscript -GodotVersion 4.5 -SpineVersion 3.8 -Platform windows
.\build.bat -BuildFlavor csharp -GodotVersion 4.5 -SpineVersion 3.8 -Platform windows
```

macOS/Linux shell:

```bash
./build.sh -BuildFlavor gdscript -GodotVersion 4.5 -SpineVersion 3.8 -Platform macos -Arch universal
./build.sh -BuildFlavor csharp -GodotVersion 4.5 -SpineVersion 3.8 -Platform macos -Arch universal
```

Configure dependencies without compiling:

```powershell
.\build.bat -BuildFlavor gdscript -GodotVersion 4.5 -SpineVersion 3.8 -Platform windows -ConfigureOnly
```
