# Spine Godot 3D - Spine Runtime 4.3

This branch/tree is the Godot 4.3+ GDExtension build of the Spine Godot 3D runtime for Spine Runtime 4.3 data.
...
| Spine Runtime branch | 4.3 only in this tree |
...
`	ext
GDScript_Build/example-v4-extension-Spine-4.3/
CSharp_Build/example-v4-csharp-Spine-4.3/
spine_godot/
build/
`
...
`powershell
.\build.bat -BuildFlavor gdscript -GodotVersion 4.5 -SpineVersion 4.3 -Platform windows
.\build.bat -BuildFlavor csharp -GodotVersion 4.5 -SpineVersion 4.3 -Platform windows
`
...
`powershell
.\build.bat -BuildFlavor gdscript -GodotVersion 4.5 -SpineVersion 4.3 -Platform windows -ConfigureOnly
`
