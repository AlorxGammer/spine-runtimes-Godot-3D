...
func _animation_started(_sprite: SpineSprite, _animation_state: SpineAnimationState, track_entry: SpineTrackEntry):
	print("Animation started: " + track_entry.get_animation().get_name())

func _animation_interrupted(_sprite: SpineSprite, _animation_state: SpineAnimationState, track_entry: SpineTrackEntry):
	print("Animation interrupted: " + track_entry.get_animation().get_name())

func _animation_ended(_sprite: SpineSprite, _animation_state: SpineAnimationState, track_entry: SpineTrackEntry):
	print("Animation ended: " + track_entry.get_animation().get_name())

func _animation_completed(_sprite: SpineSprite, _animation_state: SpineAnimationState, track_entry: SpineTrackEntry):
	print("Animation completed: " + track_entry.get_animation().get_name())

func _animation_disposed(_sprite: SpineSprite, _animation_state: SpineAnimationState, track_entry: SpineTrackEntry):
	print("Animation disposed: " + track_entry.get_animation().get_name())
	
func _animation_event(_sprite: SpineSprite, _animation_state: SpineAnimationState, track_entry: SpineTrackEntry, event: SpineEvent):
